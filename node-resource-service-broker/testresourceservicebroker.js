    ...
    try
    {
        ...
        var result = 
        {
            ...
            [
                {
                    bindable         : true,
                    description      : SERVICE_NAME + " Test Node Resource Service Broker Display Name",
                    ...
                    id               : "423e587c-4cba-46c1-a410-626013b109ca",
                    metadata         : 
                    {
                        displayName         : "QE Test Service " + SERVICE_NAME,
                        ...
                        longDescription     : SERVICE_NAME + " Test Node Resource Service Broker Long Description",
                        providerDisplayName : "QE Test Company",
                    ...
                    [
                        {
                            bindable    : true,
                            description : SERVICE_NAME + " Test Node Resource Service Broker Plan Description",
                            free        : true,
                            // TODO - GUID generated by http://www.guidgenerator.com
                            // TODO - This service plan id must be unique within an IBM Cloud environment's set of service plans
                            id          : "2f89c8b6-3d8a-474a-9139-3021c3f1c48e",
                            metadata    :
                            {
                                bullets     : [SERVICE_NAME+ " Test bullet 1", SERVICE_NAME+" Test bullet 2"],
                                displayName : "Lite"
                            },
